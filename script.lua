herelocal Players = cloneref(game:GetService('Players'))
local RS = cloneref(game:GetService('RunService'))
local UIS = game:GetService('UserInputService')
local Client = Players.LocalPlayer

local size = 30
local showVisuals = true -- Новая переменная для скрытия кубов
...
MainFrame.Size = UDim2.new(0, 250, 0, 170) -- Немного увеличил высоту под новую кнопку
...
OpenBtn.Text = "H"; OpenBtn.TextColor3 = Color3.new(1,1,1); OpenBtn.Font = "GothamBold"
OpenBtn.Visible = false; OpenBtn.Parent = ScreenGui
...
Title.Text = 'Hitbox v2 Final'; Title.TextColor3 = Color3.new(1,1,1); Title.Font = "GothamBold"; Title.TextSize = 14; Title.TextXAlignment = "Left"

-- Кнопки управления
local CloseBtn = Instance.new('TextButton', Header)
CloseBtn.Size = UDim2.new(0, 30, 0, 30); CloseBtn.Position = UDim2.new(1, -32, 0, 2); CloseBtn.Text = "×"; CloseBtn.TextColor3 = Color3.new(1,0,0); CloseBtn.BackgroundTransparency = 1; CloseBtn.TextSize = 20
CloseBtn.MouseButton1Click:Connect(function() ScreenGui:Destroy() end)

local MinBtn = Instance.new('TextButton', Header)
MinBtn.Size = UDim2.new(0, 30, 0, 30); MinBtn.Position = UDim2.new(1, -62, 0, 2); MinBtn.Text = "—"; MinBtn.TextColor3 = Color3.new(1,1,1); MinBtn.BackgroundTransparency = 1; MinBtn.TextSize = 18
MinBtn.MouseButton1Click:Connect(function() MainFrame.Visible = false; OpenBtn.Visible = true end)
OpenBtn.MouseButton1Click:Connect(function() MainFrame.Visible = true; OpenBtn.Visible = false end)

-- Слайдер
local SizeLabel = Instance.new('TextLabel', MainFrame)
SizeLabel.Size = UDim2.new(1, 0, 0, 20); SizeLabel.Position = UDim2.new(0, 12, 0, 40)
...
SliderFrame.Size = UDim2.new(1, -24, 0, 25); SliderFrame.Position = UDim2.new(0, 12, 0, 65); SliderFrame.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
Instance.new("UICorner", SliderFrame)

local SliderButton = Instance.new('TextButton', SliderFrame)
SliderButton.Size = UDim2.new(0, 30, 1, 0); SliderButton.Position = UDim2.new((size - 5) / 95, 0, 0, 0); SliderButton.BackgroundColor3 = Color3.fromRGB(255, 0, 0); SliderButton.Text = ""
Instance.new("UICorner", SliderButton)

-- НОВАЯ КНОПКА: Скрыть/Показать кубы
local VisualsBtn = Instance.new('TextButton', MainFrame)
VisualsBtn.Size = UDim2.new(1, -24, 0, 35); VisualsBtn.Position = UDim2.new(0, 12, 0, 110)
VisualsBtn.BackgroundColor3 = Color3.fromRGB(45, 45, 45); VisualsBtn.Text = "Visuals: ON"; VisualsBtn.TextColor3 = Color3.new(1,1,1); VisualsBtn.Font = "GothamBold"
...
RS.RenderStepped:Connect(function()
    ...
    -- Применение изменений к игрокам
    for _, Player in pairs(Players:GetPlayers()) do
        if Player ~= Client and Player.Character and Player.Character:FindFirstChild('HumanoidRootPart') then
            ...
            if Hum and Hum.Health > 0 then
                ...
                -- Если Visuals OFF, ставим прозрачность 1 (невидимка)
